(function (global) {
  ...
  function newSlide() {
    ...
    const raw = `<section class="slide" data-slide-id="slide-${String(index + 1).padStart(2, "0")}" data-screen-label="${String(index + 1).padStart(2, "0")}" style="background:#ffffff"><h2 style="position:absolute;left:140px;top:120px;font-size:64px">新页面标题</h2><p style="position:absolute;left:145px;top:260px;width:900px;font-size:32px;color:#667085">在这里添加页面内容。</p></section>`;
    const warnings = { add() {} };
